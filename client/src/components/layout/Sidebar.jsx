...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-navy min-h-screen flex flex-col text-white">
      ...
      <button
        onClick={logout}
        className="flex items-center gap-3 px-3 py-3 m-3 rounded-md text-sm text-white/80 hover:bg-white/10"
      >
        <LogOut size={18} />
        Déconnexion
      </button>
