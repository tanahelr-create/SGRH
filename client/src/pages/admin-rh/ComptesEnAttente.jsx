        ...
        {accounts.map((a) => (
          <div key={a.id} className="bg-white rounded-lg shadow p-5 flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500">{a.email} — Matricule {a.matricule}</p>
              <span className="inline-block mt-1 text-xs px-2 py-0.5 rounded bg-gray-100 text-gray-600">{a.role}</span>
            </div>
